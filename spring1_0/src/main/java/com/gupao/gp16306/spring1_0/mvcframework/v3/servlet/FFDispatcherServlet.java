package com.gupao.gp16306.spring1_0.mvcframework.v3.servlet;

import com.gupao.gp16306.spring1_0.mvcframework.annotation.*;
...
//        if(!this.handlerMapping.containsKey(url)){
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        System.out.println("FF Spring framework is init.");
    }
    ...
    private void initHandlerMapping() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            if(!clazz.isAnnotationPresent(FFController.class)){continue;}


            //保存写在类上面的@FFRequestMapping("/demo")
            String baseUrl = "";
            ...
            for (Method method : clazz.getMethods()) {
                if(!method.isAnnotationPresent(FFRequestMapping.class)){continue;}
        ...
        private void putParamIndexMapping(Method method) {
            ...
            for (int i = 0; i < pa.length; i++) {
                for (Annotation a : pa[i]) {
                    if (a instanceof FFRequestParam) {
                        String paramName = ((FFRequestParam) a).value();
