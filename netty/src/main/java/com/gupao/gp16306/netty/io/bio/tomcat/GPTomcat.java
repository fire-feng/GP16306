package com.gupao.gp16306.netty.io.bio.tomcat;
...
public class GPTomcat {
    ...
    private Map<String, FFServlet> servletMapping = new HashMap<String,FFServlet>();
        ...
        try{
            ...
            for (Object k : webxml.keySet()) {
                ...
                if(key.endsWith(".url")){
                    ...
                    //单实例，多线程
                    FFServlet obj = (FFServlet)Class.forName(className).newInstance();
    ...
    private void process(Socket client) throws Exception {
        ...
        FFRequest request = new FFRequest(is);
        FFResponse response = new FFResponse(os);
